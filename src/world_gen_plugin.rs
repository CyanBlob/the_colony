...
fn create_world(mut commands: Commands, image_assets: Res<MyAssets>) {
    ...
    let terrain_textures = vec![
        &image_assets.ugly_grass,
        &image_assets.ugly_grass2,
        &image_assets.ugly_grass3,
        &image_assets.ugly_grass4,
        &image_assets.ugly_grass,
        &image_assets.ugly_grass2,
        &image_assets.ugly_grass3,
        &image_assets.ugly_grass4,
        ...
        &image_assets.ugly_grass3,
        &image_assets.ugly_grass4,
        &image_assets.ugly_mud,
        &image_assets.ugly_mud2,
        &image_assets.ugly_mud3,
        &image_assets.ugly_mud4,
    ];
